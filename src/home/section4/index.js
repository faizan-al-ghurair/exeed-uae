...
const HomeCarouselBanner = ({ img }) => {
  return (
    <li class="carousel-img-placeholder-home">
      <div>
        <img src={img} alt="..." />
          ...
          <div class="col-12 col-md-10">
            <div class=" col-md-12 col-12 d-flex justify-content-center align-items-center specs-columns-container">
              ...
              <div class="specs-columns home-carousel-specs-border">
                <div class="row d-flex justify-content-center align-items-center modal-banner-spec-container-home">
                  <div class="elementor-icon-box-wrapper text-center col-md-4 col-4">
                    <div class="w-100">
                      <span class="">
                        <svg
                  ...
                  <div class="elementor-icon-box-content-header-icons header-modal-specs col-md-8 col-8">
              ...
              <div class="specs-columns home-carousel-specs-border">
                <div class="row d-flex justify-content-center align-items-center modal-banner-spec-container-home">
                  ...
                  <div class="elementor-icon-box-content-header-icons header-modal-specs col-md-8 col-8">
                    <div class="justify-content-center">
                      <h3 class="justify-content-start">
                        <span class="white-banner-text-label">Horse Power</span>
                      </h3>
                    </div>
                    <span class="white-banner-text-value modal-specs-values">
                      261
        ...
        {/* <div class="position-absolute top-0 row d-flex w-100 h-100 justify-content-center align-items-center elementor-background-overlay-gradient">
          ...
          <div
            class="pb-5 col-md-3 h-100 d-flex align-items-end  justify-content-center"
            data-id="788e685a"
            data-element_type="column"
          >
            <div
            ...
            >
              <div class="elementor-widget-container row justify-content-center align-items-center">
                <div class="elementor-icon-box-wrapper col-md-3">
                  <div class="w-100">
                    <span class="">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="elementor-icon-box-content col-md-8 ">
                  <div class="justify-content-center">
                    <h3 class="justify-content-start">
                      <span class="white-banner-text-label">Seat Capcity </span>
                    </h3>
                  </div>
                  <span class="white-banner-text-value">5 </span>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <div class="elementor-widget-container row justify-content-center align-items-center">
                ...
                <div class="elementor-icon-box-content col-md-8 ">
                  ...
                  <span class="white-banner-text-value"> 1.6L TGDI </span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              <div class="row justify-content-center align-items-center">
                ...
                <div class="elementor-icon-box-content col-md-10 justify-content-center">
                  <div>
                    <div class="justify-content-center">
                      <h3 class="justify-content-start">
                        <span class="white-banner-text-label px-4">
                          Horse Power
                        </span>
                      </h3>
                    </div>
                    <span class="white-banner-text-value px-4">197</span>
                  </div>
                </div>
              </div>
            </div>
    ...
    <>
      <section class="elementor-section">
        <div class="carousel-container-home">
          <ul class="carousel">
            <HomeCarouselBanner img="https://exeed-uae.com/wp-content/uploads/2023/07/banner-txl.webp" />
            <HomeCarouselBanner img="https://exeed-uae.com/wp-content/uploads/2023/07/banner-txl.webp" />
            <HomeCarouselBanner img="https://exeed-uae.com/wp-content/uploads/2023/07/banner-txl.webp" />
            <HomeCarouselBanner img="https://exeed-uae.com/wp-content/uploads/2023/07/banner-txl.webp" />
          </ul>
