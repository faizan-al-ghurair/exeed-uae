...
export const Section1 = () => {
  ...
  window.onload = (event) => {          
    ...
    month.addEventListener('change', () => {
      ...
      document.getElementById("LeaseRate-calcu").onclick = function() {calculatePrice()};
                ...
                <div class="col-12">  
                  ...
                  <div class="finacialLease-Left">
                    <div class="elementor-widget-wrap elementor-element-populated">
                      <div class="elementor-element elementor-element-7bb0f6b elementor-widget__width-initial elementor-widget elementor-widget-html" data-id="7bb0f6b" data-element_type="widget" data-widget_type="html.default">
                      ...
                      <div class="elementor-element elementor-element-5a34e8d4 elementor-widget__width-initial elementor-widget elementor-widget-html" data-id="5a34e8d4" data-element_type="widget" data-widget_type="html.default">
                        <div class="elementor-widget-container">
                          <label id="carSelection">Please Select Car</label>
                        </div>
                      </div>
                      <div class="elementor-element elementor-element-6903c9a2 elementor-widget elementor-widget-html" data-id="6903c9a2" data-element_type="widget" data-widget_type="html.default">
                        <div class="elementor-widget-container">
                       ...
                       <div class="btn-area">
                            ...
                            <div class="calc-price-parent">
                              <div class="elementor-widget-container">
                                <div id="finacialLease-price"></div> </div>
                            </div>
                       </div>  
