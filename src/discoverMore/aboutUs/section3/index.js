        ...
        <div class="col-md-12 d-flex py-5">
          <div class="col-md-10 w-100 d-flex justify-content-center">
            <div class="row d-flex justify-content-center align-items-start aboutus-section3">
              {/* <div class="col-md-10 col-sm-10 col-10 abtus-section3-flex d-flex justify-content-center">
                <div class="col-md-6 col-sm-12 col-12">
                  ...
                  <div class="">
                    <p>
                      ...
                      Smart Cars Introducing A Premium Smart Car Brand Crafted
                      For Those Who Dare To Explore And Embrace Breakthroughs
                      Around The World. With Our Brand Orientation Focused On
                      “Premium, Elegance, And Intelligence,” We Are Committed To
                      Consistently Delivering The Concept Of A Life Enriched By
                      New Technologies That Surpass Expectations.
                    </p>
                    <p>
                      At Our Core, We Understand That Today’s Consumers Crave
                      More Than Just A Means Of Transportation; They Seek A
              ...
              <div
                class="col-md-10 col-sm-12 col-10 abtus-section3-flex d-flex 
                justify-content-center"
              >
                <div class="aboutus-sec3-text">
                  <div class="title-white-wrapper">
                    <h2 class="title-white">{"Brand Orientation"}</h2>
                    <h1 class="title-orange">
                      {"Learn About Our Orientation"}
                    ...
                    <div class="aboutus-section3-facts col-md-12">
                      <div class="aboutus-section3-facttab col-md-4 col-sm-12 col-12">
                        <h5>PREMIUM</h5>
                      </div>
                      <div class="aboutus-section3-facttab col-md-4 col-sm-12 col-12">
                        <h5>ELEGANCE</h5>
                ...
                <div class="aboutus-sec3-img"></div>
              </div>
            </div>
          </div>
        </div>
