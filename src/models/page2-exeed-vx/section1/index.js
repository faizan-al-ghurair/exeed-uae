          ...
          >
            <div class="carousel-inner ">
              <div class="">
                <div>
                  <img
                    class="position-relative w-100 modelHeader-section "
                    src="https://exeed-uae.com/wp-content/uploads/2023/07/22-VX.png"
                    alt="..."
                  />
                </div>

                <div class="absolute-details-car-banner d-flex w-100 align-items-center justify-content-center">
                  <div class="col-12 col-md-10">
                    <h1 class="title-orange title-banner-modal">
                      {"EXEED VX"}
                    </h1>
                    <div
                      class=" col-md-12 col-12 d-flex justify-content-center align-items-center testing
            "
                    >
                      <div class="col-md-3 col-5 ">
                        <div class=" row d-flex justify-content-center align-items-center modal-banner-spec-container">
                          <div class="elementor-icon-box-wrapper text-center col-md-3 col-4">
                            <div class="w-100">
                              <span class="">
                                <svg
                                  class="information-svg-modal-banner"
                          ...
                          <div class="elementor-icon-box-content-header-icons header-modal-specs col-md-9 col-8">
                            ...
                            <span class="white-banner-text-value modal-specs-values">
                              20 Inches
                            </span>
                          </div>
                        </div>
