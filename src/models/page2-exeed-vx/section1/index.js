...
const CarouselItem = ({ active }) => {
  return (
    <div class={`carousel-item ${active}`}>
      ...
      <div class="row section-spacing position-absolute top-0  d-flex w-100 h-100 justify-content-center align-items-center elementor-background-overlay-gradient">
        <div
          class="pb-5 col-md-3 col-sm-12 h-100 d-flex align-items-end  justify-content-center"
          data-id="134ccbbe"
        ...
        <div
          class="pb-5 col-sm-12 col-md-3 h-100 d-flex align-items-end justify-content-center"
          data-id="788e685a"
          data-element_type="column"
        >
          <div
          ...
          >
            <div class="elementor-widget-container row justify-content-center align-items-center">
              ...
              <div class="elementor-icon-box-content col-md-8 ">
                <div class="justify-content-center">
                  <h3 class="justify-content-start">
                    <span class="white-banner-text-label">Engine Capacity</span>
                  </h3>
                </div>
        ...
        <div
          class="col-sm-12 pb-5 col-md-3 h-100 d-flex align-items-end justify-content-center"
          data-id="788e685a"
          data-element_type="column"
        >
          <div
